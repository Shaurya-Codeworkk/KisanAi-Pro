...
def predict_with_agent(data: AgentInput):
    ...
    try:
        ...
        # This is a new, single function to process everything cleanly.
        recommendations = process_recommendations(final_data, base_details['city_or_state'])
...
def predict_with_manual_input(data: ManualInput):
    ...
    try:
        ...
        recommendations = process_recommendations(final_data, location)
        return recommendations
...
def get_grow_guide_endpoint(crop_name: str):
    ...
    try:
        ...
        guide_data = get_crop_dynamic_details(crop_name) # Using a function from your app.py
        if not guide_data:
...
def process_recommendations(final_data: Dict, location: str) -> Dict:
